...
const routeContracts = [
  ...
  {
    route: "answer-engine-optimization-generator",
    requiredTexts: [
      "Answer Engine Optimization Generator",
      "answer engine optimization copy",
  ...
  {
    route: "pricing-table-copy-generator",
    requiredTexts: [
      "Pricing Table Copy Generator",
      "pricing table copy",
      "plan names",
  ...
  {
    route: "product-launch-email-generator",
    requiredTexts: [
      "Product Launch Email Generator",
  ...
  {
    route: "demo-follow-up-email-generator",
    requiredTexts: [
      "Demo Follow-Up Email Generator",
      "demo follow-up emails",
  ...
  {
    route: "back-in-stock-sms-generator",
    requiredTexts: [
      "Back-in-Stock SMS Generator",
      "back-in-stock SMS alerts",
      "Shopify restock texts",
      "low-stock reminders",
  ...
  {
    route: "post-purchase-sms-generator",
    requiredTexts: [
      "Post-Purchase SMS Generator",
      "post-purchase SMS copy",
      "delivery updates",
  ...
  {
    route: "shopify-abandoned-cart-email-generator",
    requiredTexts: [
      "Shopify Abandoned Cart Email Generator",
  ...
  {
    route: "shopify-landing-page-copy-generator",
    requiredTexts: [
      "Shopify Landing Page Copy Generator",
      "Shopify landing page copy",
      "collection campaign sections",
      "cart-driving CTAs",
