...
- `/google-ads-description-generator` — Google Ads descriptions, responsive search ad copy, PPC offer angles, landing page hooks, SEO snippets, and CTA variants from one campaign brief
- `/google-ads-headline-generator` — responsive search ad headlines, keyword-matched PPC angles, landing page hooks, SEO snippets, and CTA variants from one campaign brief
...
- `/webinar-invitation-email-generator` — webinar invitation emails, reminder sequences, agenda teasers, speaker proof, replay follow-ups, and CTA variants from one webinar brief
...
- `/coupon-email-generator` — coupon emails, promo code announcements, redemption reminders, offer FAQs, urgency angles, and click-ready CTAs from one discount campaign brief
...
- `/thank-you-page-copy-generator` — thank you page copy, post-conversion next steps, upsell and referral CTAs, confirmation page FAQs, and SEO snippets from one offer brief
...
- `/product-launch-email-generator` — product launch emails, pre-launch teasers, launch-day announcements, follow-up sequences, FAQs, and conversion CTAs from one go-to-market brief
...
- `/back-in-stock-sms-generator` — back-in-stock SMS alerts, Shopify restock texts, low-stock reminders, compliance-safe opt-out language, and mobile CTAs from one restock brief
...
- `/product-positioning-generator` — product positioning statements, differentiation angles, messaging pillars, SEO snippets, FAQs, and CTA variants from one product brief.
...
- `/ai-product-listing-generator` — product listing titles, descriptions, marketplace SEO snippets, feature bullets, FAQs, social previews, and buy-now CTAs for Shopify, Amazon, Etsy, and ecommerce catalogs
...
- `/product-explainer-video-generator` — product explainer videos, explainer video scripts, problem-solution storyboards, voiceover hooks, scene-by-scene outlines, and launch CTAs from one product brief
...
- `/terms-and-conditions-generator` — terms and conditions copy, store policy clauses, checkout acceptance language, support-reducing terms FAQs, and trust snippets from one business rules brief
